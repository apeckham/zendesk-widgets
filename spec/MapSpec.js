describe("Maps", function() {
  it("loads", function() {
    ...
    window.google = {maps: {}};
    google.maps.Map = jasmine.createSpy('google.maps.Map');
    google.maps.LatLng = Class.create({
      initialize: function() {
        this.arguments = arguments;
      }
    });
    google.maps.MapTypeId = {ROADMAP: 10101};
    ...
    expect(google.maps.Map.mostRecentCall.args[0]).toEqual(element);
