...
describe("Ticket", function() {
  ...
  it("should extract server parameters", function() {
    ...
    expect(ticket.getServerParameters().HTTP_USER_AGENT).toEqual("Mozilla/5.0 (Windows; U; Windows NT 6.1; en-US) AppleWebKit/533.4 (KHTML, like Gecko) Chrome/5.0.375.126 Safari/533.4");
  });
